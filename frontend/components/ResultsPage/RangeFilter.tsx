    ...
    <div className='RangeFilter'>
      ...
      <div className='RangeFilter__input'>
        <div className='RangeFilter__range-min'>
          ...
          <input type='string' className='RangeFilter__input-box' value={ selected.min } onChange={ (event) => setActive({ min:Number(event.target.value), max:selected.max }) } />
        </div>
        <div>
          <label className='RangeFilter__label-max'>To: </label>
          <input type='string' className='RangeFilter__input-box' value={ selected.max } onChange={ (event) => setActive({ min: selected.min, max:Number(event.target.value) }) } />
        </div>
      </div>
    </div>
  );
