# Migration `20200914015147-initial`

This migration has been generated by gamburgm at 9/13/2020, 9:51:47 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER INDEX "public"."unique_course_props" RENAME TO "uniqueCourseProps"
```
